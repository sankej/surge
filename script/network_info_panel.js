...
!(async () => {
  ...
  if (!wifi.ssid && $network['cellular-data']) {
...
function HTTP(
  ...
  function t(t, u) {
      ...
      f = new Promise((e, s) => {
        ...
        n[t.toLowerCase()](u, (t, n, i) => {
          t
            ? s(t)
            : e({
                statusCode: n.status || n.statusCode,
                headers: n.headers,
                body: i,
              })
        })
    ...
    const p = h
      ? new Promise((e, s) => {
          d = setTimeout(
            () => (l.onTimeout(), s(`${t} URL: ${u.url} exceeds the timeout ${h} ms`)),
            h,
          )
        })
      : null
    return (p ? Promise.race([p, f]).then((e) => (clearTimeout(d), e)) : f).then((e) =>
      l.onResponse(e),
    )
  }
